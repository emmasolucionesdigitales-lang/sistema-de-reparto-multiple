...
// usarInformes (envío por PDF adjunto) — reemplazada por la versión de
// 16-extras.js (envío de HTML directo por Brevo, sin PDF). Esa es la que
// realmente se usa: al declararse después en el orden de carga de
// index.html, pisaba a esta silenciosamente. Se saca de acá para no
// confundir a quien la edite pensando que tiene efecto.
