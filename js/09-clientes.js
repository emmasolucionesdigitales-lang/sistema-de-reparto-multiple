...
function ListaClientes({
  ...
  const Card = ({
    ...
    }, "No quiso"))), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        flexDirection: "column",
        gap: 8,
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: s.badge("success")
  }, visitados.size, "/", clientes.length, " visitados"), volverAlFinal.length > 0 && /*#__PURE__*/React.createElement("span", {
    style: s.badge("warning")
  ...
  }, clienteMoviendo ? `📍 Tocá el # de dónde debería ir "${clientes.find(c => c.id === clienteMoviendo)?.nombre || ""}" (tocá el mismo para cancelar)` : "Tocá el # de un cliente para moverlo, después tocá dónde debería ir")), filtrados.length === 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: "center",
      padding: "40px 20px",
...
function DetalleCliente({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, recActivos.length)), !soloLectura && /*#__PURE__*/React.createElement("button", {
    style: {
      ...s.btn,
      fontSize: 12,
      padding: "5px 10px"
  ...
  }, ventas.length, " compras"))), /*#__PURE__*/React.createElement("div", {
    style: {
      ...s.card,
      margin: "0 0 10px",
  ...
  }, "💰 Cobrar"), !soloLectura && /*#__PURE__*/React.createElement("button", {
    style: {
      ...s.btn,
      fontSize: 11,
      padding: "4px 10px"
  ...
  }, "Ajustar"), !soloLectura && /*#__PURE__*/React.createElement("button", {
    style: {
      ...s.btn,
      fontSize: 11,
      padding: "4px 10px"
  ...
  }, "📋 Historial (", ventas.length, " compras · ", fmt(totalComprado), ")"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 11,
      color: "var(--color-text-tertiary)"
    }
  ...
  }, historial.length === 0 && /*#__PURE__*/React.createElement("p", {
    style: {
      fontSize: 13,
      color: "var(--color-text-tertiary)",
      padding: "4px 0"
    }
  }, "Sin registros aún"), historial.map(v => /*#__PURE__*/React.createElement("div", {
    key: v.id,
    style: {
      marginBottom: 8
    }
  ...
  })(), v.desc > 0 ? ` · desc. ${fmt(v.desc)}` : "", v.saldoAplicado > 0 ? ` · saldo ${fmt(v.saldoAplicado)}` : "", v.obs ? ` · ${v.obs.replace(/\s*\[Mixto:[^\]]*\]/g, "")}` : ""), v.pago === "fiado" && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      fontWeight: 600,
  ...
  }, v._pagada ? "✓ Pagada" : v._montoPagadoAcum > 0 ? `Debe ${fmt((v.neto || 0) - (v._montoPagadoAcum || 0))} · pagó ${fmt(v._montoPagadoAcum)} parcial` : `Debe ${fmt(v.neto || 0)}`), !soloLectura && /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      justifyContent: "flex-end",
      gap: 6
  ...
  }, "Eliminar"))))))), /*#__PURE__*/React.createElement("details", {
    style: {
      marginTop: 6
    }
  }, /*#__PURE__*/React.createElement("summary", {
    ...
    style: s.badge("success")
  }, "×", e.cant))))))), !soloLectura && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    style: {
      ...s.divider,
      marginTop: 12
    }
  ...
  }, "Eliminar cliente"))))), editandoCliente && !soloLectura && /*#__PURE__*/React.createElement(EditCliente, {
    cliente: cliente,
    onGuardar: cambios => {
      onEditar(cambios);
...
function EditCliente({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    key: d,
    value: d
  }, d)))), [["nombre", "Nombre y apellido"], ["barrio", "Barrio"], ["manzana", "Manzana"], ["lote", "Lote"], ["sector", "Sector"], ["calle", "Calle"], ["nro", "Número"], ["telefono", "Teléfono (sin 0 ni 15)"], ["maps", "Link Google Maps"], ["foto", "Link foto del domicilio (Google Drive, etc)"]].map(([k, l]) => /*#__PURE__*/React.createElement("div", {
    key: k
  }, /*#__PURE__*/React.createElement("label", {
    style: s.label
  ...
  }, "unidades prestadas"))), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("label", {
    style: s.label
  }, "Saldo (corrección manual)"), /*#__PURE__*/React.createElement("input", {
    style: s.input,
    type: "number",
    value: datos.saldo || 0,
    onChange: e => set("saldo", Number(e.target.value))
  })), datos.foto && /*#__PURE__*/React.createElement("div", {
    style: {
      position: "relative",
      cursor: "zoom-in"
    },
  ...
  }, "🔍 Ampliar")), /*#__PURE__*/React.createElement("button", {
    style: s.btnPrimary,
...
function FiadosPendientes({
  ...
  }, c.dia, c.barrio ? ' · ' + c.barrio : '')), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 16,
      fontWeight: 700,
      color: 'var(--color-text-danger)'
...
function ClientesDormidos({
  ...
  }, "Sin comprar hace:"), [2, 3, 4, 8].map(n => /*#__PURE__*/React.createElement("button", {
    key: n,
  ...
  }, c.dia, direccionCliente(c) ? " · " + direccionCliente(c) : ""), nombreRepartidor(c) && /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 11,
      color: "var(--color-text-info)",
      marginTop: 2
    }
  }, "🚚 ", nombreRepartidor(c)), /*#__PURE__*/React.createElement("div", {
    style: {
      fontSize: 12,
      fontWeight: 600,
